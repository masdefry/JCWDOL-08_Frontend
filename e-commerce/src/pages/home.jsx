        ...
        <div className="flex">
            ...
            <div className="basis-3/5">
                ...
                <div className="pl-12 pt-8 mb-6">
                    ...
                    <button className='rounded-full px-3 py-1 mt-4 ml-3 font-semibold'>
                        Join now
                    </button>
                    <button className='rounded-full px-3 py-1 ml-3' style={{ border: '1px solid black' }} >
                        Learn more
                    </button>
            </div>
            ...
            <div className='py-10 my-bg-light flex justify-center'>
                ...
                <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <div className='flex justify-between bg-green-700 p-3 rounded-md'>
